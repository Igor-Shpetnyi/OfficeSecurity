        ...
        response = await client.aio.models.generate_content(
            ...
            config=types.GenerateContentConfig(
                system_instruction=(
                    ...
                    "в самому тексті сповіщення. НЕ цитуй службове формулювання "
                    "буквально (напр. не пиши 'Деталі: зафіксовано слово \"X\"') — "
                    "перекажи своїми словами, що саме зафіксовано (напр. яка ціль), "
                    "природною мовою, а не як цитату внутрішнього логу виявлення."
                ),
